...
//
// https://roniruny.tistory.com/146 expandable tableview
...
class NoticeView: UIView {
    ...
    var notice : Notice? {
        didSet {
            ...
            tableView.register(NoticeTitleTableViewCell.self, forCellReuseIdentifier: "TableViewCell1")
...
extension NoticeView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            let cell = tableView.cellForRow(at: indexPath) as! NoticeTitleTableViewCell
